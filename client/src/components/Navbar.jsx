  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        />
        <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary py-4 ${toggleDrawer ? 'translate-y-0' : '-translate-y-[100vh]'} transition-all duration-700`}>
          <ul className="mb-4">
            {navlinks.map(link => (
              <li
                key={link.name}
